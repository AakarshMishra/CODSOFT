...
public class AddTaskFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Validate the input
                if (TextUtils.isEmpty(title) || TextUtils.isEmpty(date) || TextUtils.isEmpty(time) || time.equals("Time")) {
                    ...
                    if (lineCount > 3) {
                        ...
                        if (timeDifferenceInMinutes < 6) {
                            ...
                            saveTaskToFirebase(title, date, time, content,comp);
                        }
                    }
                }
            }
    ...
    private void saveTaskToFirebase(String title, String date, String time, String content,boolean comp) {
        ...
        Task task=new Task(title,date,time,content,comp);
