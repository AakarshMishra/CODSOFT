...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.deleteImageView.setOnClickListener(v -> showDeleteConfirmationDialog(task));
    }

    private void updateTaskCompletion(Task task, boolean isCompleted) {
        task.setComp(isCompleted);
        tasksRef.child(task.getKey()).setValue(task);
    }
    ...
    private void showDeleteConfirmationDialog(final Task task) {
        ...
        builder.setPositiveButton("Delete", (dialog, which) -> deleteTask(task));
    ...
    public static class TaskViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Task task) {
            ...
            completedCheckBox.setChecked(task.isComp());
        }
